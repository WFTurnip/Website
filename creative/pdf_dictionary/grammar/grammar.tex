...
\begin{description}
\item[ピスピ文字]
エレギア帝国成立以前の{Xwnasw Piswpi} ハナス・ピスピ
...
共和連合時代に用いられた書体。{Comwnwnaqanw} オムンナーン
という神が創造したと伝説上では語られている。
\item[スリーヴェ体]
{sulive}

{Xwnasw Piswpi} ハナス・ピスピ
共和連合時代に用いられた書体である。{Sulive} スリーヴェ
...
エレギア帝国建国時にそれまで祀られていた五神{Comwnwnaqanw} オムンナーン
、{Caxwkwsiqica} アフクスィーア 、{Pwratwluqusw} プラトゥルース
、{Tanalapoteqe} タナラポテー 、{Camiricaqalw} アミリアール

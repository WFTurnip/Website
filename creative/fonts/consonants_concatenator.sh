...
for fontname in "${fontname[@]}"; do
    ...
    if [ "${fontname}" = "piswpi" ]; then
        cat "${fontname}"/uni0053.svg "${fontname}"/uni0027.svg "${fontname}"/uni0030.svg >"${fontname}"/uni004a.svg
        cat "${fontname}"/uni0051.svg "${fontname}"/uni0027.svg "${fontname}"/uni0030.svg >"${fontname}"/uni0059.svg
    fi
done

...
\paragraph{子音発音説明}\label{subsection2.1.2}
...
\paragraph{母音発音説明}\label{subsection2.2.2}
...
\subparagraph{約物の使用法}\label{subsubsection3.3.1}
...
\subparagraph{基本単語構造}\label{subsubsection4.1.1}
...
\subparagraph{子音概念表}\label{subsubsection4.2.1}

\subparagraph{子音概念図}\label{subsubsection4.2.2}
...
\paragraph{接周辞}\label{subsection4.7}

C\textsubscript{prefix}C\textsubscript{1}C\textsubscript{2}C\textsubscript{3}C\textsubscript{suffix}

\paragraph{接周辞図表}\label{subsection4.7.1}

\subparagraph{接周辞表}\label{subsubsection4.7.1.1}

\subparagraph{接周辞図}\label{subsubsection4.7.1.2}
...
\paragraph{複合格の説明}\label{subsection5.3.2}
...
\paragraph{接頭辞格説明}\label{subsection5.4.2}
...
\paragraph{品詞分類図表}\label{subsection5.6.1}

\subparagraph{品詞分類表}\label{subsubsection5.6.1.1}

\subparagraph{品詞分類図}\label{subsubsection5.6.1.2}
...
\paragraph{品詞分類説明}\label{subsection5.6.2}
...
\paragraph{附詞活用説明}\label{subsection10.1.2}
...
\paragraph{動詞活用説明}\label{subsubsection10.2.2}
...
\subsubsection{容詞活用図表}\label{section10.3}
...
\paragraph{容詞活用説明}\label{subsubsection10.3.2}
...
\subsubsection{助詞活用図表}\label{section10.4}
...
\paragraph{助詞活用説明}\label{subsection10.4.2}
...
\paragraph{副詞活用説明}\label{subsection10.5.2}
...
\paragraph{名詞活用説明}\label{subsubsection10.6.2}

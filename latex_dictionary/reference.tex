...
本書はエレギア帝国帝立大学言語学研究所によって刊行された辞典、{Cinarwziqili Beruvwdikwtw}{イナールズィーリ・ベルーヴディクト}の巻末資料{Cinarwziqili Gwlamwdufunw}{イナールズィーリ・グラームドゥフーン}を日本語に翻訳したものである。
...
\input{consonants_pronunciation_table}
...
\input{vowels_pronunciation_table}
...
\input{consonants_concept_table}

...
\section{子音}\label{section2.1}

子音文字は調音部位を象った形状を持ち、音声学的な特徴を視覚的に表現している。

\subsection{子音表}\label{subsection2.1.1}

\subsection{子音図}\label{subsection2.1.2}
...
\item[{q}]
この文字は{{[}\textglotstop{]}}という発音であることを指す。
\item[{c}]
この文字は{{[}\textrevglotstop{]}}という発音であることを指す。
\item[{r}]
...
\section{母音}\label{section2.2}

この言語において母音符号の付与は限定的であり、特に初学用や幼児用に母音符号を記述することもある。

\subsection{母音表}\label{subsection2.2.1}

\subsection{母音図}\label{subsection2.2.1}
...
\subsection{約物の使用法}\label{subsection3.3.1}
...
\subsection{基本単語構造}\label{subsection4.1.1}

エレギア語の基本単語構造はC\textsubscript{1}V\textsubscript{1}C\textsubscript{2}V\textsubscript{2}C\textsubscript{3}V\textsubscript{3}となる。これは原型となる単語のことであって、活用形などは後述する\hyperref[section4.5]{接辞}の節にて単語構造が拡張される。
...
\subsection{子音概念表}\label{subsection4.2.1}

\subsection{子音概念図}\label{subsection4.2.2}
...
\section{接辞}\label{section4.5}

\subsection{接頭辞}\label{subsection4.5.1}

C\textsubscript{\sc{prefix}}C\textsubscript{1}C\textsubscript{2}C\textsubscript{3}

\subsection{接尾辞}\label{subsection4.5.2}

C\textsubscript{1}C\textsubscript{2}C\textsubscript{3}C\textsubscript{\sc{suffix}}

\subsection{複合接辞}\label{subsection4.5.3}

C\textsubscript{\sc{prefix}}C\textsubscript{1}C\textsubscript{2}C\textsubscript{3}C\textsubscript{\sc{suffix}}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\chapter{格}\label{chapter5}
...
\subsection{前置格表}\label{subsection5.1.1}

\subsection{前置格図}\label{subsection5.1.2}
...
\subsection{後置格表}\label{subsection5.2.1}

\subsection{後置格図}\label{subsection5.2.2}
...
\subsection{複合格表}\label{subsection5.3.1}

\subsection{複合格図}\label{subsection5.3.2}
...
\subsection{接頭辞格表}\label{subsection5.4.1}

\subsection{接頭辞格図}\label{subsection5.4.2}
...
\subsection{接尾辞格表}\label{subsection5.5.1}

\subsection{接尾辞格図}\label{subsection5.5.2}
...
\chapter{品詞}\label{chapter6}

\section{品詞分類}\label{section6.1}

エレギア語の品詞には附詞、動詞、容詞、助詞、副詞、名詞が存在する。

\subsection{品詞表}\label{subsection6.1.2}

\subsection{品詞図}\label{subsection6.1.2}
...
\chapter{文構造}\label{chapter7}

\section{基本文型}\label{section7.1}

主語、述語、目的語の配置

\section{複文と従属文}\label{section7.2}

複文の構成、従属節の使い方

\section{否定文と疑問文}\label{section7.3}

否定や疑問の表現方法

\section{強調と焦点}\label{section7.4}

文の中で特定の部分を強調する方法

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\chapter{特殊構文}\label{chapter8}

\section{受動態}\label{section8.1}
...
\section{能動態と中動態}\label{section8.2}
...
\chapter{辞書の使用方法}\label{chapter9}

\section{辞書の使用方法}\label{section9.1}

語彙の検索方法や辞書の構成

エレギア語の辞書では主に語根からの派生形を捜査する形式となっている。

\section{新語彙の生成規則}\label{section9.2}

新しい語彙を作る規則

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\chapter{付録}\label{chapter10}

\section{重要な語句}\label{section10.1}

エレギア語でよく使われる語句を提示する。

\subsection{よく使われる語句}\label{subsection10.1.1}
...
\chapter{活用図表}\label{chapter11}

\section{附詞活用図表}\label{section11.1}

附詞の格変化、数、定及び不定の概念など

\subsection{附詞活用表}\label{subsection11.1.1}

\subsection{附詞活用図}\label{subsection11.1.2}
...
\subsection{附詞活用説明}\label{subsection11.1.3}
...
\section{動詞活用図表}\label{section11.2}

動詞の活用、時制、態、相など

\subsection{動詞活用表}\label{subsection11.2.1}

\subsection{動詞活用図}\label{subsection11.2.2}
...
\subsection{動詞活用説明}\label{subsection11.2.3}
...
\section{容詞活用図表}\label{section11.3}

容詞の格変化、数、定及び不定の概念など

\subsection{容詞活用表}\label{subsection11.3.1}

\subsection{容詞活用図}\label{subsection11.3.2}
...
\subsection{容詞活用説明}\label{subsection11.3.3}
...
\section{助詞活用図表}\label{section11.4}

助詞の機能と用法

\subsection{助詞活用表}\label{subsection11.4.1}

\subsection{助詞活用図}\label{subsection11.4.2}
...
\subsection{助詞活用説明}\label{subsection11.4.3}
...
\section{副詞活用図表}\label{section11.5}

副詞の格変化、数、定及び不定の概念など

\subsection{副詞活用表}\label{subsection11.5.1}

\subsection{副詞活用図}\label{subsection11.5.2}
...
\subsection{副詞活用説明}\label{subsection11.5.3}
...
\section{名詞活用図表}\label{section11.6}

名詞の格変化、数、定及び不定の概念など

\subsection{名詞活用表}\label{subsection11.6.1}

\subsection{名詞活用図}\label{subsection11.6.2}
...
\subsection{名詞活用説明}\label{subsection11.6.3}

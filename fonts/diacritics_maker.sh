...
for fontname in "${fontname[@]}"; do
    # cp ${fontname}/uni0307.svg ${fontname}/uni030c.svg
    # cp ${fontname}/uni0323.svg ${fontname}/uni032c.svg
    ...
    # inkscape ${fontname}/uni0304.svg
    # inkscape ${fontname}/uni0331.svg
    # inkscape ${fontname}/uni0302.svg
    # inkscape ${fontname}/uni032d.svg
    # inkscape ${fontname}/uni030c.svg
    # inkscape ${fontname}/uni032c.svg
done
